...
export default function ScanScreen({ navigation }) {
  return (
    <View style={{ flex: 1, backgroundColor: "#F9E8D9", justifyContent: "center", alignItems: "center" }}>
      ...
      <Image source={require("./assets/th.jpg")} style={{ width: 200, height: 400, resizeMode: "contain" }} />
      ...
      <View style={{
       ...
       <Image source={require("./assets/th.jpg")} style={{ width: 40, height: 40, resizeMode: "contain" }} />
